      ...
      success(res){
        ...
        while(j<i){                        //遍历，选择相同id的数据，并取出
          if(that.data.id==that.data.idi[j].id){
            that.setData({
              f1:that.data.idi[j].terminal_fee,
              f2:that.data.idi[j].service_fee,
              f3:that.data.idi[j].installationl_fee,
              f4:that.data.idi[j].no_resource,
              f5:that.data.idi[j].resource
             })
        ...
        if(that.data.f1=="0"&that.data.f2=="0"&that.data.f3=="0"&that.data.f4=="0"&that.data.f5=="0"){
          wx.showToast({
            icon:"none",
            title:"该组合未存在"
          })
  ...
  link1(){     //查询无计算
    if(this.data.id1!=""&this.data.id2!=""&this.data.id3!=""&this.data.id4!=""){
      ...
      success(res){
        ...
        if(that.data.f1=="0"&that.data.f2=="0"&that.data.f2=="0"&that.data.f4=="0"&that.data.f5=="0"){
          wx.showToast({ 
            icon:"none",
            title:"该组合未存在"
          })
